...
if __name__ == "__main__":
    valtags = testtags = {'corporation':'corporation', 'creative-work':'creative work', 'group':'group', 'location':'location', 'person':'person', 'product':'product'}
    valset, testset = CoNLLDataset('../data/dev-wnut.txt', valtags), CoNLLDataset('../data/test-wnut.txt', testtags)
    
    valset.re_tag_and_write('../data/dev-wnut.txt')
    testset.re_tag_and_write('../data/test-wnut.txt')
