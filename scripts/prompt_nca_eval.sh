...
--max_length 64 --model ProML --seed 0 --name ProMLvis --proj-dim 128 --only_test --load_ckpt checkpoint/RUN_ALL_ProML_FewNERD_INTRA5way1shot_seed=0_mix-rate=0.7.pth.tar --visualize


# CUDA_VISIBLE_DEVICES=0 python3 train_demo.py  --mode intra \
# --lr 3e-5 --batch_size 1 --trainN 5 --N 5 --K 1 --Q 1 \
# --train_iter 5000 --val_iter 500 --test_iter 50 --val_step 1000 \
# --max_length 64 --model container --seed 0 --name CONTAINERvis --proj-dim 128 --only_test --load_ckpt checkpoint/RUN_ALL_CONTAINER_FewNERD_INTRA5way1shot_seed=0.pth.tar --visualize