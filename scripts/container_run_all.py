...
--max_length {mx_len} --model container --use_sampled_data --tau 0.05 --seed {seed} --name RUN_ALL_CONTAINER_FewNERD_{exp_type}_seed={seed} --proj-dim 128 --with-dropout --trainK {trainK} > outputs/run_all_logs_sampled_fewnerd/RUN_ALL_CONTAINER_FewNERD_{exp_type}_seed={seed}'
...
--lr 3e-5 --batch_size {bsz} --trainN {trainN} --N {testN} --K {testK} --Q {testQ} \
--train_iter 10000 --val_iter 500 --test_iter 5000 --val_step 1000 \
--max_length {mx_len} --model container --tau 0.05 --seed {seed} --name RUN_ALL_CONTAINER_OntoNotes_{exp_type}_seed={seed} --use-onto-split {label_set} --proj-dim 128 --with-dropout --trainK {trainK} > outputs/run_all_logs/RUN_ALL_CONTAINER_OntoNotes_{exp_type}_seed={seed}'
...
--lr 3e-5 --batch_size {bsz} --trainN {trainN} --N {testN} --K {testK} --Q {testQ} \
--train_iter 10000 --val_iter 500 --test_iter 5000 --val_step 1000 \
--max_length {mx_len} --model container --tau 0.05 --seed {seed} --name RUN_ALL_cased_CONTAINER_OntoNotes_DomainTransferPretrained_{exp_type}_seed={seed} --use-ontonotes --proj-dim 128 --with-dropout --trainK {trainK} > outputs/run_all_logs/RUN_ALL_cased_CONTAINER_OntoNotes_DomainTransferPretrained_{exp_type}_seed={seed}'
...
--lr 3e-5 --batch_size {bsz} --trainN {trainN} --N {testN} --K {testK} --Q {testQ} \
--train_iter 10000 --val_iter 500 --test_iter 5000 --val_step 1000 \
--max_length {mx_len} --model container --tau 0.05 --seed {seed} --totalN {totalN} --topk 1 --name RUN_ALL_CONTAINER_OntoNotes_{exp_type}_seed={seed}_FULLTESTEVAL --proj-dim 128 --with-dropout --trainK {trainK} --only_test --full-test --use-onto-split {label_set} --load_ckpt=checkpoint/RUN_ALL_CONTAINER_OntoNotes_{exp_type}_seed={seed}.pth.tar > outputs/run_all_logs/TagExtensionEval/RUN_ALL_CONTAINER_OntoNotes_{exp_type}_seed={seed}_FULLTESTEVAL'
    scripts_list = []
...
--lr 3e-5 --batch_size {bsz} --trainN {trainN} --N {testN} --K {testK} --Q {testQ} \
--train_iter 10000 --val_iter 500 --test_iter 5000 --val_step 1000 \
--max_length {mx_len} --model container --eval-with-finetune --tau 0.05 --seed {seed} --totalN {totalN} --topk 1 --name RUN_ALL_cased_CONTAINER_OntoNotes_DomainTransferPretrained_{exp_type}_seed={seed}_FULLTESTEVAL_{targetDomain} --proj-dim 128 --with-dropout --trainK {trainK} --only_test --full-test {arg_dataset} --load_ckpt=checkpoint/RUN_ALL_cased_CONTAINER_OntoNotes_DomainTransferPretrained_{exp_type}_seed={seed}.pth.tar > outputs/run_all_logs/DomainTransferEval/RUN_ALL_cased_CONTAINER_OntoNotes_DomainTransferPretrained_{exp_type}_seed={seed}_FULLTESTEVAL_{targetDomain}'
    scripts_list = []
