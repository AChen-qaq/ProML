...
--max_length {mx_len} --model transfer --no-shuffle --eval-with-finetune --seed {seed} --name RUN_ALL_TransferBERT_OntoNotes_{exp_type}_seed={seed} --use-conll {label_set} --trainK {trainK} > outputs/run_all_logs/RUN_ALL_TransferBERT_OntoNotes_{exp_type}_seed={seed}'
